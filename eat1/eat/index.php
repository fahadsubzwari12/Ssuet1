    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="thumbnail">
                       <a href="items.php?id=19&cc=refresh"><img src="images/deal1.jpg" alt="..."></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="thumbnail">
                        <a href="items.php?id=3&cc=refresh"><img src="images/deal2.jpg" alt="..."></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="thumbnail">
                        <a href="items.php?id=1&cc=refresh"><img src="images/deal3.png" alt="..."></a>
                    </div>
                </div>
            </div>
                   ...
                   LIMIT 4";
                                ...
                                while($orow = mysql_fetch_array($orslt)) {
                                    ...
                                    if($oname != 'temp') {
                                        ...
                                        <li class="news-item">An order of <?php echo $res_name; ?> restaurant was placed by <?php echo $oname; ?>
